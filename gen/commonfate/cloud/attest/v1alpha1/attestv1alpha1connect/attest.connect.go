...
const (
	...
	AttestServiceName = "commonfate.cloud.attest.v1alpha1.AttestService"
)
...
const (
	...
	// RegisterDevice RPC.
	AttestServiceRegisterDeviceProcedure = "/commonfate.cloud.attest.v1alpha1.AttestService/RegisterDevice"
)

// AttestServiceClient is a client for the commonfate.cloud.attest.v1alpha1.AttestService service.
...
// NewAttestServiceClient constructs a client for the commonfate.cloud.attest.v1alpha1.AttestService
...
// RegisterDevice calls commonfate.cloud.attest.v1alpha1.AttestService.RegisterDevice.
...
// AttestServiceHandler is an implementation of the commonfate.cloud.attest.v1alpha1.AttestService
// service.
...
func NewAttestServiceHandler(svc AttestServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/commonfate.cloud.attest.v1alpha1.AttestService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAttestServiceHandler) RegisterDevice(context.Context, *connect_go.Request[v1alpha1.RegisterDeviceRequest]) (*connect_go.Response[v1alpha1.RegisterDeviceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfate.cloud.attest.v1alpha1.AttestService.RegisterDevice is not implemented"))
}
