...
package commonfatecloudv1alpha1connect

import (
	context "context"
	errors "errors"
	connect_go "github.com/bufbuild/connect-go"
	v1alpha1 "github.com/common-fate/ciem/gen/proto/commonfatecloud/v1alpha1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UserManagementServiceName = "commonfatecloud.v1alpha1.UserManagementService"
...
const (
	...
	UserManagementServiceListUsersProcedure = "/commonfatecloud.v1alpha1.UserManagementService/ListUsers"
	// ConnectionsServiceListConnectionsProcedure is the fully-qualified name of the
	// ConnectionsService's ListConnections RPC.
	ConnectionsServiceListConnectionsProcedure = "/commonfatecloud.v1alpha1.ConnectionsService/ListConnections"
	// ConnectionsServiceAddConnectionProcedure is the fully-qualified name of the ConnectionsService's
	// AddConnection RPC.
	ConnectionsServiceAddConnectionProcedure = "/commonfatecloud.v1alpha1.ConnectionsService/AddConnection"
	// ConnectionsServiceRemoveConnectionProcedure is the fully-qualified name of the
	// ConnectionsService's RemoveConnection RPC.
	ConnectionsServiceRemoveConnectionProcedure = "/commonfatecloud.v1alpha1.ConnectionsService/RemoveConnection"
	// ConnectionsServiceListAWSAccountsProcedure is the fully-qualified name of the
	// ConnectionsService's ListAWSAccounts RPC.
	ConnectionsServiceListAWSAccountsProcedure = "/commonfatecloud.v1alpha1.ConnectionsService/ListAWSAccounts"
	...
	ConnectionsServiceGetAWSRolesForAccountProcedure = "/commonfatecloud.v1alpha1.ConnectionsService/GetAWSRolesForAccount"
	...
	UsageMetricsServiceGetAWSRoleMetricsProcedure = "/commonfatecloud.v1alpha1.UsageMetricsService/GetAWSRoleMetrics"
	...
	AccessServiceCreateAccessRequestProcedure = "/commonfatecloud.v1alpha1.AccessService/CreateAccessRequest"
)

// UserManagementServiceClient is a client for the commonfatecloud.v1alpha1.UserManagementService
// service.
...
// commonfatecloud.v1alpha1.UserManagementService service. By default, it uses the Connect protocol
...
// ListUsers calls commonfatecloud.v1alpha1.UserManagementService.ListUsers.
...
// commonfatecloud.v1alpha1.UserManagementService service.
...
func NewUserManagementServiceHandler(svc UserManagementServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/commonfatecloud.v1alpha1.UserManagementService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserManagementServiceHandler) ListUsers(context.Context, *connect_go.Request[v1alpha1.ListUsersRequest]) (*connect_go.Response[v1alpha1.ListUsersResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfatecloud.v1alpha1.UserManagementService.ListUsers is not implemented"))
}

// ConnectionsServiceClient is a client for the commonfatecloud.v1alpha1.ConnectionsService service.
...
// commonfatecloud.v1alpha1.ConnectionsService service. By default, it uses the Connect protocol
// with the binary Protobuf Codec, asks for gzipped responses, and sends uncompressed requests. To
// use the gRPC or gRPC-Web protocols, supply the connect.WithGRPC() or connect.WithGRPCWeb()
// options.
//
...
// ListConnections calls commonfatecloud.v1alpha1.ConnectionsService.ListConnections.
...
// AddConnection calls commonfatecloud.v1alpha1.ConnectionsService.AddConnection.
...
// RemoveConnection calls commonfatecloud.v1alpha1.ConnectionsService.RemoveConnection.
...
// ListAWSAccounts calls commonfatecloud.v1alpha1.ConnectionsService.ListAWSAccounts.
...
// GetAWSRolesForAccount calls commonfatecloud.v1alpha1.ConnectionsService.GetAWSRolesForAccount.
...
// ConnectionsServiceHandler is an implementation of the commonfatecloud.v1alpha1.ConnectionsService
// service.
...
func NewConnectionsServiceHandler(svc ConnectionsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/commonfatecloud.v1alpha1.ConnectionsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedConnectionsServiceHandler) ListConnections(context.Context, *connect_go.Request[v1alpha1.ListConnectionsRequest]) (*connect_go.Response[v1alpha1.ListConnectionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfatecloud.v1alpha1.ConnectionsService.ListConnections is not implemented"))
}
...
func (UnimplementedConnectionsServiceHandler) AddConnection(context.Context, *connect_go.Request[v1alpha1.AddConnectionRequest]) (*connect_go.Response[v1alpha1.AddConnectionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfatecloud.v1alpha1.ConnectionsService.AddConnection is not implemented"))
}
...
func (UnimplementedConnectionsServiceHandler) RemoveConnection(context.Context, *connect_go.Request[v1alpha1.RemoveConnectionRequest]) (*connect_go.Response[v1alpha1.RemoveConnectionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfatecloud.v1alpha1.ConnectionsService.RemoveConnection is not implemented"))
}
...
func (UnimplementedConnectionsServiceHandler) ListAWSAccounts(context.Context, *connect_go.Request[v1alpha1.ListAWSAccountsRequest]) (*connect_go.Response[v1alpha1.ListAWSAccountsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfatecloud.v1alpha1.ConnectionsService.ListAWSAccounts is not implemented"))
}
...
func (UnimplementedConnectionsServiceHandler) GetAWSRolesForAccount(context.Context, *connect_go.Request[v1alpha1.ListAWSRolesForAccountRequest]) (*connect_go.Response[v1alpha1.ListAWSRolesForAccountResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfatecloud.v1alpha1.ConnectionsService.GetAWSRolesForAccount is not implemented"))
}

// UsageMetricsServiceClient is a client for the commonfatecloud.v1alpha1.UsageMetricsService
// service.
...
// commonfatecloud.v1alpha1.UsageMetricsService service. By default, it uses the Connect protocol
// with the binary Protobuf Codec, asks for gzipped responses, and sends uncompressed requests. To
// use the gRPC or gRPC-Web protocols, supply the connect.WithGRPC() or connect.WithGRPCWeb()
// options.
//
...
// GetAWSRoleMetrics calls commonfatecloud.v1alpha1.UsageMetricsService.GetAWSRoleMetrics.
...
// GetUsageForRole calls commonfatecloud.v1alpha1.UsageMetricsService.GetUsageForRole.
...
// commonfatecloud.v1alpha1.UsageMetricsService service.
...
func NewUsageMetricsServiceHandler(svc UsageMetricsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/commonfatecloud.v1alpha1.UsageMetricsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUsageMetricsServiceHandler) GetAWSRoleMetrics(context.Context, *connect_go.Request[v1alpha1.GetAWSRoleMetricsRequest]) (*connect_go.Response[v1alpha1.GetAWSRoleMetricsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfatecloud.v1alpha1.UsageMetricsService.GetAWSRoleMetrics is not implemented"))
}
...
// NewAccessServiceClient constructs a client for the commonfatecloud.v1alpha1.AccessService
...
// commonfatecloud.v1alpha1.AccessService.ListEntitlementsForProvider.
...
// CreateAccessRequest calls commonfatecloud.v1alpha1.AccessService.CreateAccessRequest.
...
func (UnimplementedAccessServiceHandler) CreateAccessRequest(context.Context, *connect_go.Request[v1alpha1.CreateAccessRequestRequest]) (*connect_go.Response[v1alpha1.CreateAccessRequestResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("commonfatecloud.v1alpha1.AccessService.CreateAccessRequest is not implemented"))
}
